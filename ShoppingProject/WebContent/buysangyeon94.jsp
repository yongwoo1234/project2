...
<div class="container" style="width: 100%">
      ...
      <div class="row"><h1 class="page-header" style="text-align: center; margin-bottom: 50px;"></h1>
         <input type="hidden" value="sangyeon94" id="product">
      </div>
      <div class="row" style="float: left; text-align: center; width:35%; margin-left:100px;">
         <img src="img/sangyeon94.jpeg" style="width: 130%">
      </div>

      <div class="row productInfo" style="width: 40%; float: right;" >
         <div class="form-group" style="text-align: left;">
            <div class="product_name">Sangyeon94</div>
            <input type="hidden" value="sangyeon94" name="product">
         	</div>
         <br>
         <div class="form-group" style="text-align: left;">
            <label>가격 : 350</label><span>&nbsp;원</span>
	   ...
	   <table class="recommend" border=0>
	      ...
	      <col width="25%">
	         ...
	         <tr align="center">
	            ...
	            <td><a href="yeji97index.jsp"><img src="img/yeji97.jpeg" width="200px"></a></td>
